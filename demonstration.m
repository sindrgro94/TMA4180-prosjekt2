...
% To make the method terminate, the tolerance for the 2-norm of the gradient
% to the lagrangian is set to 0.2 and stepSelection is false meaning we use
...
max_iter = 1000;
angle = pi/2;
answer = BC_Augmented_Lagrangian(THETA,L,P,angle,max_iter); %time?1min
plotHandMovement(answer,L,P);
